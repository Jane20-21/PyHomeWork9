...
def show(update, context):
    context.bot.send_message(update.effective_chat.id,
                             'Введите название для справочника, после просмотра справочника, для выхода напишите /stop ')
    return 1
...
def add(update, context):
    context.bot.send_message(update.effective_chat.id,
                             'Введите новый контакт в формате Фамилия Имя Телефон Коментарий через пробел:\n После просмотра справочника, для выхода напишите /stop ')
    return 1
